...
<head>
    ...
    <link rel="icon" href="${request.static_url('pyramidstarter:static/favicon.ico')}" type="image/x-icon"/>
    <link rel="shortcut icon" href="${request.static_url('pyramidstarter:static/favicon.ico')}" type="image/x-icon"/>
...
<div class="container-fluid">
    ...
    <div class="row my-5">
        <div class="col-lg-1 offset-lg-2 hidden-sm">
            <img src="${request.static_url('pyramidstarter:static/Owlbear.jpg')}" width="100%" alt="owlbear icon"/>
        </div><!--icon-->
        ...
        <h2><i class="far fa-hat-wizard"></i> Motives <i class="far fa-chevron-up" id="OFF_motive" onclick="flip('motive',0)"></i><i
            ...
            <div id="DIV_link" class="text-justify">
                <ul class="fa-ul">
                    ...
                    <li><i class="fa-li far fa-cogs"></i> <a href="/dnd-review">Backpage
...
ga('send', 'pageview');
    ...
    <script type="text/javascript" src="${request.static_url('pyramidstarter:static/dnd.js')}"></script>
