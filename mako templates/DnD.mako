...
<head>
    ...
    <link rel="icon" href="${request.static_url('pyramidstarter:static/favicon.ico', _scheme='https')}" type="image/x-icon"/>
    <link rel="shortcut icon" href="${request.static_url('pyramidstarter:static/favicon.ico', _scheme='https')}" type="image/x-icon"/>
    ...
    <%def name='card(section, title, icon, subtitle="")'>
        <div class="card">
            ...
            <i class="far fa-chevron-down" id="ON_${section}" onclick="flip('${section}',1)"></i></h3>
                ...
                <%include file="DnD_${section}.mako" />
            </div>
            </div>
        </div>
    </%def>
...
<div class="container">
    <div class="row my-3">
        <div class="col-lg-1 offset-lg-2 hidden-sm">
            <img src="${request.static_url('pyramidstarter:static/Owlbear.jpg', _scheme='https')}" width="100%" alt="owlbear icon"/>
        </div><!--icon-->
...
ga('send', 'pageview');
    ...
    <script type="text/javascript" src="${request.static_url('pyramidstarter:static/dnd.js', _scheme='https')}"></script>
